...
### Automatic build using CI

This project is configured to use **GitHub Actions** to build and push the image on the [Kalisio's Docker Hub](https://hub.docker.com/u/kalisio/).
The built image is tagged using the `version` property in the `package.json` file.

More information can be found in the [Kalisio development toolkit](https://github.com/kalisio/development).
